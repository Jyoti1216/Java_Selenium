...
public class CreateProject_TestScenario4 {
	...
	private void TestCase() throws Throwable {
		...
		createproject.Click(Locators.Setting);
		createproject.Click(Locators.ActionButton);
		createproject.Click(Locators.AddIssue);
		createproject.Click(Locators.IssuePage);
